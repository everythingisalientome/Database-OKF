---
type: relationship
tables: [MUSICSTORE_CORE.CORE.playlist_track, MUSICSTORE_SALES.SALES.invoice_line]
built_from: [db/MUSICSTORE_CORE@2026-08-23, db/MUSICSTORE_SALES@2026-08-23]
---

## playlist_track.track_id <-> invoice_line.track_id
- [observed] containment: 1.0 (primary); jaccard: 0.566 (exact, hash-set)
- [observed] evidence: 8715 x 2240 rows; confidence: medium
